package org.marathon.exception;
...
public enum ErrorType {
    ...
    PRODUCT_NOT_CREATED(1005, "URUN KAYDEDILEMEDI", INTERNAL_SERVER_ERROR),
    NOT_UNIQUE_PRODUCT_CODE(1005, "URUN KODU DAHA ONCE TANIMLANMISTIR", INTERNAL_SERVER_ERROR),
